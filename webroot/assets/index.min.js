...
async function updateDeviceInfo() {
    ...
    if (!isEnvironmentSupported) {
        deviceInfoDiv.innerHTML = '<div class="error-message">Kernel SU API access is missing</div>';
        return;
    }
...
async function updateStatus() {
    ...
    if (!isEnvironmentSupported) {
        statusDiv.innerHTML = '<div class="error-message">Kernel SU API access is missing</div>';
