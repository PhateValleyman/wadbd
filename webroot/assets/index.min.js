...
async function toggleWirelessAdb(e) {
    if (isEnvironmentSupported) try {
        ...
        t < 1024 || 65535 < t ? alert("Neplatný port! Zadejte port mezi 1024 a 65535.") : (await exec("setprop service.adb.tcp.port " + (e ? t : "-1")), await exec("stop adbd"), await exec("start adbd"))
    } catch (e) {
